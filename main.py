...
class Entries:
    ...
    def del_entry(self):
        ...
        ok_button = Button(master=mw.top, text='OK', command=lambda: [mw.cancel(), self.set_to_delete_true()])
...
if __name__ == "__main__":
    ...
    app.add_button('delete_text_line', 'Удалить активную строчку', 'delete_text_line', hot_key='<Control-x>')
